...
namespace Excel
{
	...
	public class ExcelBinaryReader : IExcelDataReader
	{
		...
		private readonly ReadOption m_ReadOption = ReadOption.Loose;
		...
		private void DumpBiffRecords()
		{
			...
			{
				rec = m_stream.Read();
			    Console.WriteLine("rec id: " + rec.ID + " isCell: " + rec.IsCell + " offset " + rec.Offset + " record size " + rec.RecordSize + " rec size " + rec.Size);
